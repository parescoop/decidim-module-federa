...
Decidim::Webpacker.register_entrypoints(
  decidim_federa: "#{base_path}/app/packs/entrypoints/decidim_federa.js",
)

# If you want to import some extra SCSS files in the Decidim main SCSS file
# without adding any extra stylesheet inclusion tags, you can use the following
# # method to register the stylesheet import for the main application.
Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/federa/federa")
#
# # If you want to do the same but include the SCSS file for the admin panel's
# # main SCSS file, you can use the following method.
Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/federa/admin/application", group: :admin)